...
The version in this repo is built for talents from [Hololive](https://hololive.hololivepro.com/en/talents?gp=hololive) and forken from [ufalsalman/better-holosort](https://github.com/ufalsalman/better-holosort), but the sorter can be easily edited to create any custom sorter desired.
